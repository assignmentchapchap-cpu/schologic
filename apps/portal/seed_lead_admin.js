...
async function seed() {
    const templates = [
        {
            name: 'New Institutional Lead Notification',
            subject: '[LEAD] {{institution}} - Pilot Request',
            category: 'admin',
            content_html: `
<div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; line-height: 1.6; color: #1e293b; background: white; border: 1px solid #e2e8f0; border-top: 4px solid #4f46e5;">
  <div style="padding: 30px;">
    ...
    <div style="margin-bottom: 30px;">
      ...
      <table style="width: 100%; border-collapse: collapse;">
        <tr>
          ...
          <td style="padding: 10px 0; font-size: 14px; font-weight: 600;">{{firstName}} {{lastName}}</td>
        </tr>
        <tr>
          <td style="padding: 10px 0; font-size: 14px; color: #64748b;">Position</td>
          <td style="padding: 10px 0; font-size: 14px;">{{jobTitle}}</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td style="padding: 10px 0; font-size: 14px; font-weight: 600;">{{institution}}</td>
        </tr>
        <tr>
          <td style="padding: 10px 0; font-size: 14px; color: #64748b;">Scale</td>
          <td style="padding: 10px 0; font-size: 14px;">{{institutionSize}} students</td>
        </tr>
        <tr>
          <td style="padding: 10px 0; font-size: 14px; color: #64748b;">Current LMS</td>
          <td style="padding: 10px 0; font-size: 14px;">{{currentLms}}</td>
        </tr>
      </table>
    </div>
    ...
    <div style="background: #f8fafc; padding: 20px; border-radius: 8px; margin-bottom: 30px;">
      ...
      <p style="margin: 0 0 5px 0; font-size: 14px; color: #1e293b;"><strong>Core Foundations:</strong> {{coreModules}}</p>
      <p style="margin: 0; font-size: 14px; color: #1e293b;"><strong>Value Accelerators:</strong> {{valueModules}}</p>
    ...
    <div style="border-top: 1px solid #f1f5f9; padding-top: 20px; font-size: 11px; color: #94a3b8; text-align: center;">
      ...
      `
        ...
        {
            name: 'Pilot Request Acknowledged',
...
<div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden; max-width: 600px; margin: 0 auto; line-height: 1.6; color: #334155;">
  ...
  <div style="padding: 40px 30px;">
    ...
    <p style="font-size: 15px;">Your inquiry regarding a <strong>Schologic Institutional Pilot</strong> at <strong>{{institution}}</strong> has been secured by our priority system.</p>
    ...
    <div style="margin: 40px 0;">
      ...
      <div style="display: flex; align-items: flex-start; margin-bottom: 25px;">
        ...
        <div>
          ...
          <p style="margin: 4px 0 0 0; font-size: 13px; color: #64748b;">A strategist will review your institution's specific requirements (<strong>{{institutionSize}} students, {{currentLms}}</strong>).</p>
        </div>
      </div>
    ...
    <div style="background: #f8fafc; border: 1px solid #f1f5f9; border-radius: 12px; padding: 25px; margin-top: 30px;">
      ...
      <p style="margin: 5px 0; font-size: 13px;"><strong>Lead Stakeholder:</strong> {{firstName}} {{lastName}}</p>
      <p style="margin: 5px 0; font-size: 13px;"><strong>Core Foundations:</strong> {{coreModules}}</p>
      <p style="margin: 5px 0; font-size: 13px;"><strong>Value Accelerators:</strong> {{valueModules}}</p>
    </div>
